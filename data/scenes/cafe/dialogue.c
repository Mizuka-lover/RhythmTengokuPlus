...
const char *cafe_dialogue_live_music[] = {
    /* ------------------------------------------------ */
        "\n"
        "それはそうと、\n"
        "お客さんは ライブとか\n"
...
const char *cafe_dialogue_guitar_practice[] = {
    /* ------------------------------------------------ */
        "\n"
        "それはそうと、\n"
        "このまえ、友人からギターを\n"
...
const char *cafe_dialogue_jogging_music[] = {
    /* ------------------------------------------------ */
        "\n"
        "それはそうと、健康のために\n"
        "ジョギングを始めたんですヨ。\n"
...
const char *cafe_dialogue_coffee_aroma[] = {
    /* ------------------------------------------------ */
        "\n"
        "それはそうと、実は私\n"
        "コーヒーにはこだわるんですよ。\n"
...
const char *cafe_dialogue_plants_music[] = {
    /* ------------------------------------------------ */
        "\n"
        "それはそうと、草や花も\n"
        "音楽をきくってはなし\n"
...
const char *cafe_dialogue_music_power[] = {
    /* ------------------------------------------------ */
        "\n"
        "それはそうと、\n"
        "やっぱり音楽はいいですよね。\n"
...
const char *cafe_dialogue_movies[] = {
    /* ------------------------------------------------ */
        "\n"
        "あ、そうそう。\n"
        "お客さんは　映画とかは\n"
...
const char *cafe_dialogue_universe[] = {
    /* ------------------------------------------------ */
        "\n"
        "そういえば、私。\n"
        "「宇宙」というものに\n"
...
const char *cafe_dialogue_black_coffee[] = {
    /* ------------------------------------------------ */
        "\n"
        "お客さん、\n"
        "ブラックコーヒーは\n"
...
const char *cafe_dialogue_origin_of_music[] = {
    /* ------------------------------------------------ */
        "\n"
        "最近、思うのですが\n"
        "音楽は　どのように\n"
...
const char **cafe_random_conversation_pool[] = {
    ...
    cafe_dialogue_live_music,
    cafe_dialogue_guitar_practice,
    cafe_dialogue_jogging_music,
    cafe_dialogue_coffee_aroma,
    cafe_dialogue_plants_music,
    cafe_dialogue_music_power,
    cafe_dialogue_movies,
    cafe_dialogue_universe,
    cafe_dialogue_black_coffee,
    cafe_dialogue_origin_of_music
};
